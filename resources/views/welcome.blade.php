...
<div class="row">
  <div class="col-md-7">
    ...
    {{ Form::open(['method'=>'post', 'url'=>url('subscribe'), 'class'=>'form-homepage submit-ajax']) }}
    <div class="row">
      <div class="col-md-7">
        <h4>Get early access and receive your free copy of the "Ultimate Travel Checklist" today!</h4>
      </div>
      <div class="col-md-7">
